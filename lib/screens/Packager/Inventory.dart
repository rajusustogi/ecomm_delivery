...
import 'package:ecomm_delivery/Models/InventoryModel.dart';
...
class _InventoryState extends State<Inventory> {
  Future<List<InventoryData>> getInventroy() async {
    SharedPreferences pref = await SharedPreferences.getInstance();
    String token = pref.getString('token');
    var response = await http.get(INVENTORY, headers: {"authorization": token});
    print(response.body);
    if (response.statusCode == 200) {
      InventoryModel productModel = InventoryModel.fromJson(json.decode(response.body));
      print('object');
